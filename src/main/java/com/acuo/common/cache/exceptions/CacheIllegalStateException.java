package com.acuo.common.cache.exceptions;

import java.io.PrintStream;
import java.io.PrintWriter;

public final class CacheIllegalStateException extends IllegalStateException {
    /** SerialVersionUID */
    ...
    public CacheIllegalStateException(final String message) {
        super(message);
    }

    public CacheIllegalStateException(final Throwable cause) {
        super();
        _cause = cause;
    }

    public CacheIllegalStateException(final String message, final Throwable cause) {
        super(message);
        _cause = cause;
    }
