 ...
 * Most of the methods return their validated input, allowing patterns like
 * this:
 * 
 * <pre>
 * // constructor
...
public final class ArgChecker {
	 ...
	 * <p>
	 * Given the input argument, this returns normally only if it is true. This
	 * will typically be the result of a caller-specific check. For example:
	 * 
	 * <pre>
	 ...
	 * 
	 * @param validIfTrue
	 *            a boolean resulting from testing an argument
	 * @throws IllegalArgumentException
	 *             if the test value is false
	 */
	public static void isTrue(boolean validIfTrue) {
		// return void, not the argument, as no need to check a boolean method
		// argument
		if (!validIfTrue) {
	 ...
	 * <p>
	 * The message is produced using a template that contains zero to many "{}"
	 * placeholders. Each placeholder is replaced by the next available
	 * argument. If there are too few arguments, then the message will be left
	 * with placeholders. If there are too many arguments, then the excess
	 * arguments are appended to the end of the message. No attempt is made to
	 * format the arguments. See {@link Messages#format(String, Object...)} for
	 * more details.
	 * 
	 * @param validIfTrue
	 *            a boolean resulting from testing an argument
	 * @param message
	 *            the error message with {} placeholders, not null
	 * @param arg
	 ...
	 * never a good reason to validate a boolean argument value.
	 * <p>
	 * The message is produced using a template that contains zero or one "{}"
	 * placeholders. The placeholder, if present, is replaced by the argument.
	 * If there is no placeholder, the argument is appended to the end of the
	 * message.
	 * 
	 * @param validIfTrue
	 *            a boolean resulting from testing an argument
	 ...
	 * <p>
	 * Given the input argument, this returns normally only if it is false. This
	 * will typically be the result of a caller-specific check. For example:
	 * 
	 * <pre>
	 ...
	 *            the error message with {} placeholders, not null
	 * @param arg
	 *            the message arguments, not null
	 * @throws IllegalArgumentException
	 *             if the test value is true
	 */
	 ...
	 * <p>
	 * Given the input argument, this returns only if it is non-null. For
	 ...
	 * 
	 * @param <T>
	 *            the type of the input argument reflected in the result
	 * @param argument
	 *            the argument to check, null throws an exception
	 * @param name
	 *            the name of the argument to use in the error message, not null
	 ...
	 * <p>
	 * Given the input argument, this returns only if it is non-null. One use
	 * for this method is in a stream:
	 * 
	 * <pre>
	...
	// -------------------------------------------------------------------------
	/**
	 * Checks that the specified argument is non-null and matches the specified
	 * pattern.
	 * <p>
	 * Given the input argument, this returns only if it is non-null and matches
	 * the regular expression pattern specified. For example, in a constructor:
	 * 
	 * <pre>
	 ...
	 * 
	 * @param pattern
	 *            the pattern to check against, not null
	 * @param argument
	 *            the argument to check, null throws an exception
	 * @param name
	 *            the name of the argument to use in the error message, not null
	 ...
	 * and contains at least one non whitespace character. This is often linked
	 * with a call to {@code trim()}. For example, in a constructor:
	 * 
	 * <pre>
	 * this.name = ArgChecker.notBlank(name, "name").trim();
	 * </pre>
	 * <p>
	 * The argument is trimmed using {@link String#trim()} to determine if it is
	 * empty. The result is the original argument, not the trimmed one.
	 * 
	 * @param argument
	 *            the argument to check, null or blank throws an exception
	 * @param name
	 *            the name of the argument to use in the error message, not null
	 * @return the input {@code argument}, not null
	 * @throws IllegalArgumentException
	 ...
	 * <p>
	 * Given the input argument, this returns only if it is non-null and
	 * contains at least one character, which may be a whitespace character. See
	 * also {@link #notBlank(String, String)}. For example, in a constructor:
	 * 
	 * <pre>
	 ...
	 * 
	 * @param argument
	 *            the argument to check, null or empty throws an exception
	 * @param name
	 *            the name of the argument to use in the error message, not null
	 * @return the input {@code argument}, not null
	 * @throws IllegalArgumentException
	 ...
	 * <p>
	 * Given the input argument, this returns only if it is non-null and
	 * contains at least one element. The element is not validated and may be
	 * null. For example, in a constructor:
	 * 
	 * <pre>
	 ...
	 * 
	 * @param <T>
	 *            the type of the input array reflected in the result
	 * @param argument
	 *            the argument to check, null or empty throws an exception
	 * @param name
	 *            the name of the argument to use in the error message, not null
	 ...
	 * <p>
	 * Given the input argument, this returns only if it is non-null and
	 * contains at least one element. For example, in a constructor:
	 * 
	 * <pre>
	 ...
	 * 
	 * @param <T>
	 *            the element type of the input iterable reflected in the result
	 * @param <I>
	 *            the type of the input iterable, reflected in the result
	 * @param argument
	 *            the argument to check, null or empty throws an exception
	 * @param name
	 *            the name of the argument to use in the error message, not null
	 ...
	 * <p>
	 * Given the input argument, this returns only if it is non-null and
	 * contains at least one element. The element is not validated and may
	 * contain nulls if the collection allows nulls. For example, in a
	 * constructor:
	 * 
	 * <pre>
	 * this.values = ArgChecker.notEmpty(values, "values");
	 ...
	 *
	 * @param <T>
	 *            the element type of the input collection reflected in the
	 *            result
	 * @param <C>
	 *            the type of the input collection, reflected in the result
	 * @param argument
	 *            the argument to check, null or empty throws an exception
	 * @param name
	 *            the name of the argument to use in the error message, not null
	 ...
	 * <p>
	 * Given the input argument, this returns only if it is non-null and
	 * contains at least one mapping. The element is not validated and may
	 * contain nulls if the collection allows nulls. For example, in a
	 * constructor:
	 * 
	 * <pre>
	 ...
	 * 
	 * @param <K>
	 *            the key type of the input map key, reflected in the result
	 * @param <V>
	 *            the value type of the input map value, reflected in the result
	 * @param <M>
	 *            the type of the input map, reflected in the result
	 * @param argument
	 *            the argument to check, null or empty throws an exception
	 * @param name
	 *            the name of the argument to use in the error message, not null
	...
	// -------------------------------------------------------------------------
	/**
	 * Checks that the specified argument array is non-null and contains no
	 * nulls.
	 * <p>
	 * Given the input argument, this returns only if it is non-null and
	 * contains no nulls. For example, in a constructor:
	 * 
	 * <pre>
	 ...
	 *            the type of the input array reflected in the result
	 * @param argument
	 *            the argument to check, null or contains null throws an
	 *            exception
	 * @param name
	 *            the name of the argument to use in the error message, not null
	 * @return the input {@code argument}, not null
	 * @throws IllegalArgumentException
	 *             if the input is null or contains nulls
	 */
	...
	/**
	 * Checks that the specified argument collection is non-null and contains no
	 * nulls.
	 * <p>
	 * Given the input argument, this returns only if it is non-null and
	 * contains no nulls. For example, in a constructor:
	 ...
	 * <p>
	 * Given the input argument, this returns only if it is zero or greater. For
	 * example, in a constructor:
	 * 
	 * <pre>
	 ...
	 * <p>
	 * Given the input argument, this returns only if it is greater than zero
	 * using the {@code eps} accuracy for zero. For example, in a constructor:
	 * 
	 * <pre>
	 ...
	 *            the value to check
	 * @param tolerance
	 *            the tolerance to use for zero
	 * @param name
	 *            the name of the argument to use in the error message, not null
	 * @return the input {@code argument}
	 * @throws IllegalArgumentException
	 *             if the absolute value of the argument is less than eps
	 */
	 ...
	 * using the {@code eps} accuracy. For example, in a constructor:
	 * 
	 * <pre>
	 ...
	 * @return the input {@code argument}
	 * @throws IllegalArgumentException
	 *             if the absolute value of the argument is less than the
	 *             tolerance
	 */
	 ...
	 * including the lower boundary but excluding the upper boundary. For
	 * example, in a constructor:
	 * 
	 * <pre>
	 ...
	 * @return the input {@code argument}
	 * @throws IllegalArgumentException
	 *             if the argument is outside the valid range
	 */
	public static double inRange(double argument, double lowInclusive, double highExclusive, String name) {
		if (argument < lowInclusive || argument >= highExclusive) {
			throw new IllegalArgumentException(Messages.format("Expected {} <= '{}' < {}, but found {}", lowInclusive,
					name, highExclusive, argument));
		}
		return argument;
	}
	 ...
	 * <p>
	 * Given a value, this returns true if it is within the specified range
	 * including both boundaries. For example, in a constructor:
	 * 
	 * <pre>
	 ...
	 * <p>
	 * Given a value, this returns true if it is within the specified range
	 * excluding both boundaries. For example, in a constructor:
	 * 
	 * <pre>
	...
	public static double inRangeExclusive(double argument, double lowExclusive, double highExclusive, String name) {
		if (argument <= lowExclusive || argument >= highExclusive) {
			throw new IllegalArgumentException(Messages.format("Expected {} < '{}' < {}, but found {}", lowExclusive,
					name, highExclusive, argument));
		}
		return argument;
	}
	 ...
	 * <p>
	 * Given two comparable instances, this checks that the first is "less than"
	 * the second. Two equal values also throw the exception.
	 *
	 * @param <T>
	 *            the type
	 * @param obj1
	 *            the first object, null throws an exception
	 * @param obj2
	 *            the second object, null throws an exception
	 * @param name1
	 *            the first argument name, not null
	 * @param name2
	 *            the second argument name, not null
	 * @throws IllegalArgumentException
	 *             if either input is null or they are not in order
	 */
	public static <T> void inOrderNotEqual(Comparable<? super T> obj1, T obj2, String name1, String name2) {
		...
		if (obj1.compareTo(obj2) >= 0) {
			throw new IllegalArgumentException(Messages
					.format("Invalid order: Expected '{}' < '{}', but found: '{}' >= '{}", name1, name2, obj1, obj2));
		}
	}
